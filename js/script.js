(function($) {
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2024/11/15', function(event) {
    ...
    function addGalleryImages() {
        ...
        const gallery = document.getElementsByClassName('gallery-container').item(0);
        let images = [
            {
                src: 'images/gallery/img-1.jpg',
                className: 'grid wedding'
            },
            {
                src: 'images/gallery/img-3.jpg',
                className: 'grid ceremony'
            },
            {
        ...
        images.forEach((image) => {
            ...
            divElement.className = image.className;

            const anchorElement = document.createElement('a');
            anchorElement.href = image.src;
            anchorElement.className = 'fancybox';
            anchorElement.setAttribute('data-fancybox-group', 'gall-1');
